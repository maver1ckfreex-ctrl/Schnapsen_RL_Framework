...
MATRIX_FILE = "winning_rate_matrix_10k_RL_depth.csv"
...
# --- A. DEFINE THE ROSTER ---
    bot_registry_1 = [
        # RL
        {'name': 'RL-D2',        'type': 'RL',  'path': MODEL_DIR / 'RL_dp2.pth'},
        {'name': 'RL-D4',        'type': 'RL',  'path': MODEL_DIR / 'RL_dp4.pth'},
        {'name': 'RL-D6',        'type': 'RL',  'path': MODEL_DIR / 'RL_dp6.pth'},
        {'name': 'RL-D8',        'type': 'RL',  'path': MODEL_DIR / 'RL_dp8.pth'},
    ]
    bot_registry_2 = [
        #Rdeep
        ...
        {'name': 'Rdeep-D8',        'type': 'rdeep', 'depth': 8},
