...
MATRIX_FILE = "winning_rate_matrix_10k_Rdeep_dp4_Samples.csv"
#MATRIX_FILE = "winning_rate_matrix_10k_Rdeep_dp6_Samples.csv"      #If you want control depth=6 then you need set depth at load_bot_from_config 
#MATRIX_FILE = "winning_rate_matrix_10k_Rdeep_dp8_Samples.csv"      #If you want control depth=8 then you need set depth at load_bot_from_config 



# --- 1. UNIVERSAL BOT LOADER ---
...
def play_matchup_chunk(args):
    ...
    def load_bot_from_config(cfg, seed_offset):
        ...
        if cfg['type'] == 'rdeep':
            return RdeepBot(depth=4, num_samples=cfg['sample'], rand=rng, name=cfg['name'])         #If you want control depth=4 then you need use this line
            #return RdeepBot(depth=6, num_samples=cfg['sample'], rand=rng, name=cfg['name'])        #If you want control depth=6 then you need use this line
            #return RdeepBot(depth=8, num_samples=cfg['sample'], rand=rng, name=cfg['name'])        #If you want control depth=8 then you need use this line
...
# --- A. DEFINE THE ROSTER ---
    bot_registry_1 = [
        # RL
        {'name': 'Rdeep-s4',        'type': 'rdeep', 'sample': 4},
    ]
    bot_registry_2 = [
        #Rdeep
        {'name': 'Rdeep-s4',        'type': 'rdeep', 'sample': 4},
        {'name': 'Rdeep-s20',        'type': 'rdeep', 'sample': 20},
        {'name': 'Rdeep-s40',        'type': 'rdeep', 'sample': 40},
        {'name': 'Rdeep-s60',        'type': 'rdeep', 'sample': 60},
        {'name': 'Rdeep-s80',        'type': 'rdeep', 'sample': 80},
